...
Con las flechas $\leftarrow$, $\rightarrow$ Don Pedro debe girar hacia la izquierda o derecha. Con las flechas $\uparrow$, $\downarrow$ Don Pedro debe moverse hacia adelante y atrás, estando siempre sobre la superfície del terreno e inclinándose según la pendiente de la misma.
